...
#define b_DATA_PIN    3
//#define CLK_PIN   4
#define b_NUM_LEDS    28

// Neck parameters
#define n_DATA_PIN    4
//#define CLK_PIN   4
#define n_NUM_LEDS    112
...
switch (bow_pos) {
    case 0:    // red
    FastLED.clear();
    b_leds[4] = CRGB(50, 0, 0);
    b_leds[5] = CRGB(50, 0, 0);
    b_leds[18] = CRGB(50, 0, 0);
    b_leds[19] = CRGB(50, 0, 0);
    for (int i=0; i<n_NUM_LEDS; i++) {
      n_leds[i] = CRGB(50,0,0);
    }
    
    for (int i=20; i<b_NUM_LEDS; i++) {
      b_leds[i] = CRGB(50,0,0);
    }
   ...
   // FastLED.show();      
    ...
    case 1:    // yellow
    FastLED.clear();
    b_leds[6] = CRGB(50, 50, 0);
    b_leds[7] = CRGB(50, 50, 0);
    b_leds[16] = CRGB(50, 50, 0);
    b_leds[17] = CRGB(50, 50, 0);
    for (int i=0; i<n_NUM_LEDS; i++) {
      n_leds[i] = CRGB(50,50,0);
    }
    for (int i=20; i<b_NUM_LEDS; i++) {
      b_leds[i] = CRGB(50,50,0);
    }
  ...
  //  FastLED.show();      
    ...
    case 2:    // green
    FastLED.clear();
    b_leds[8] = CRGB(0, 50, 0);
    b_leds[9] = CRGB(0, 50, 0);
    b_leds[14] = CRGB(0, 50, 0);
    b_leds[15] = CRGB(0, 50, 0);
    for (int i=0; i<b_NUM_LEDS; i++) {
      n_leds[i] = CRGB(0,50,0);
    }

    for (int i=20; i<b_NUM_LEDS; i++) {
      b_leds[i] = CRGB(0,50,0);
    }
  ...
  //  FastLED.show();     
    ...
    case 3:    // blue
    FastLED.clear();
    b_leds[10] = CRGB(0, 0, 50);
    b_leds[11] = CRGB(0, 0, 50);
    b_leds[12] = CRGB(0, 0, 50);
    b_leds[13] = CRGB(0, 0, 50);
    for (int i=0; i<n_NUM_LEDS; i++) {
      n_leds[i] = CRGB(0,0,50);
    }
    for (int i=20; i<b_NUM_LEDS; i++) {
      b_leds[i] = CRGB(0,0,50);
    }
    for (int i=0; i<4; i++) {
      b_leds[i] = CRGB(0,0,50);
    }
